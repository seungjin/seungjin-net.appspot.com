...
package net.seungjin.appspot.mobile;

import net.seungjin.appspot.*;
...
public class MemoWriterServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<textarea style=\"width:300px; height:120px; padding:5px; border: 3px solid #cccccc;\" name=\"memo\" ></textarea>");
